...
@if($categoria_caricaturas)
  <div class="bg-white rounded-lg">
    <div class="flex items-center justify-between">
      <h3 class="text-[#1D447A] font-['Raleway'] text-[1.8rem] md:text-[1.85rem] font-[800] leading-[43.66px] tracking-[-0.23px] md:tracking-[-0.31px] uppercase mb-2">CARICATURAS</h3>
