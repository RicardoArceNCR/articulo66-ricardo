...
<section class="container mx-auto px-4 py-8">
  <div class="grid lg:grid-cols-4 gap-6">
    <div class="lg:col-span-3">
      <h2 class="text-[#1D447A] font-['Raleway'] text-[2rem] md:text-[2.6rem] lg:text-[2.23rem] font-[800] leading-[43.66px] tracking-[-0.23px] md:tracking-[-0.31px] uppercase mb-2">NACIONALES</h2>
      ...
      <div class="space-y-6">
        ...
        <div class="mas-leidas">
          <div class="flex items-center justify-center gap-2 mb-2">
            ...
            <h3 class="text-[#1D447A] font-['Raleway'] text-[2rem] md:text-[2rem] lg:text-[2.23rem] font-[800] leading-[43.66px] tracking-[-0.23px] md:tracking-[-0.31px] uppercase mb-2">MÁS LEÍDAS</h3>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="48" viewBox="0 0 25 48" fill="none">
