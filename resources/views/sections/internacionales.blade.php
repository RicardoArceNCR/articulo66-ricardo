...
<section class="container mx-auto px-4 py-8">
  <div class="flex items-center justify-between mb-2 relative">
    <div class="flex-1">
      <h2 class="text-[#1D447A] font-['Raleway'] text-[1.8rem] md:text-[2.20rem] font-[800] leading-[43.66px] tracking-[-0.23px] md:tracking-[-0.31px] uppercase">INTERNACIONALES</h2>
    </div>
